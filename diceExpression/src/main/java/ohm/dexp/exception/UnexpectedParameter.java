...
public class UnexpectedParameter extends DParseException {
	 ...
	 */
	public UnexpectedParameter(int atChar) {
		super(atChar, atChar);
	}
	 ...
	 * @param atChar The position in the expression at which the error occurred.
	 */
	public UnexpectedParameter(String message, int atChar, Throwable cause) {
	 ...
	 */
	public UnexpectedParameter(String message, int atChar) {
