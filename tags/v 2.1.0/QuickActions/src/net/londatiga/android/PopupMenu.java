...
public class PopupMenu extends CustomPopupWindow {
	...
	public void show () {
		...
		showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), anchorRect.centerX()-xPos, xPos, xPos + rootWidth);
	 ...
	 * @param leftMargin Coordinate of the right margin of the pop up
	 * @param rightMargin Coordinate of the right margin of the pop up
	 */
	private void showArrow(int whichArrow, int requestedX, int leftMargin, int rightMargin) {
        ...
        //Leave a space from the right border of the pop-up
        //greater or equal to half the size of the arrow to avoid glitch
        if ((requestedX + arrowWidth / 2) > (rightMargin - (leftMargin + arrowWidth / 2))) {
            param.leftMargin = (rightMargin - (leftMargin + arrowWidth / 2)) - arrowWidth;
        } else {
