...
public abstract class TokenFunctionExplodeBase extends TokenFunction {
	...
	/**
	 * Tell if the explosion is safe or if can lead to a loop.<br />
	 * An explosion is considered safe if at least one value generated by the roll
	 * out of 3 did NOT explode.
	 * @param range Number of different values generated by the roll.
	 * @param explodingRange Number of different values that causes explosion.
	 * @return {@code true} if there is no reasonable risk of loop, {@code false} otherwise.
	 */
	public static boolean loopLessExplosion(long range, long explodingRange) {
		return explodingRange == 0 || (((range * 2) / explodingRange) >= 3);
	}
}
